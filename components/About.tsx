      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6 sm:space-y-8 mb-8 sm:mb-12">
          <div className="text-center">
            ...
            <div className="space-y-4 text-sm sm:text-base lg:text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              <p>
        ...
        <div className="mb-8 sm:mb-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {successMetrics.map((metric, index) => (
              <div 
                key={metric.title} 
                className="flex flex-col items-center text-center p-4 sm:p-6 rounded-xl bg-card/50 backdrop-blur-sm hover:bg-card transition-all duration-300 hover:shadow-lg border border-border/50"
              >
                <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 flex items-center justify-center rounded-full bg-linear-to-r from-primary to-secondary text-primary-foreground mb-3 sm:mb-4">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="p-6 sm:p-8 lg:p-10 rounded-2xl bg-card shadow-lg hover:shadow-xl transition-all duration-300 border-border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
              <div className="text-center group">
                <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 flex items-center justify-center rounded-full bg-linear-to-r from-primary to-accent text-primary-foreground group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="text-center group">
                <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 flex items-center justify-center rounded-full bg-linear-to-r from-secondary to-primary text-primary-foreground group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="text-center group">
                <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 flex items-center justify-center rounded-full bg-linear-to-r from-accent to-secondary text-primary-foreground group-hover:scale-110 transition-transform duration-300">
