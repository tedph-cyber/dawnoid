      ...
      {activeTab === "dashboard" && (
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            <Card className="p-3 sm:p-4 lg:p-6 bg-linear-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border-blue-200 dark:border-blue-800 -z-10">
            ...
            <Card className="p-3 sm:p-4 lg:p-6 bg-linear-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 border-green-200 dark:border-green-800 -z-10">
              <div className="flex items-center justify-between">
                <div>
            ...
            <Card className="p-3 sm:p-4 lg:p-6 bg-linear-to-br from-orange-50 to-orange-100 dark:from-orange-950 dark:to-orange-900 border-orange-200 dark:border-orange-800 -z-10">
              <div className="flex items-center justify-between">
                <div>
            ...
            <Card className="p-3 sm:p-4 lg:p-6 bg-linear-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 border-purple-200 dark:border-purple-800 -z-10">
              <div className="flex items-center justify-between">
                <div>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="block lg:hidden space-y-3">
            {filteredProducts.map((product) => (
              <Card key={product.id} className="p-4 -z-10">
          ...
          <Card className="overflow-hidden hidden lg:block -z-10">
